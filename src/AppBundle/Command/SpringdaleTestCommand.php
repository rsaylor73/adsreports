...
class SpringdaleTestCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('app:springdaletest')
            ->setDescription('This will email the reports daily. Usage php bin/console app:springdaletest daily ads60 ads30')
            ->addArgument(
                'type',
